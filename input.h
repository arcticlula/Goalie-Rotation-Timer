...
#define MAX_INPUT_ACTIONS 5 //Ex: Click and DblClick are 2, can add up to the number you define

#define DEBOUNCE_MS 50
#define WAIT_FOR_CLICK_MS 400
#define HOLD_MS 500 // Has to bigger than WAIT_FOR_CLICK_MS if dblClick is being used
#define DISABLE_IQR_MS 500
...
typedef struct input_t {
  ...
  void (*on_dbl_click)(struct input_t *input);
